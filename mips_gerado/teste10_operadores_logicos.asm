...
Label_1:
    ...
    move $t0, $t1
    move $t1, $t2
    or $t0, $t0, $t1    # OR logico
    beq $t0, $zero, Label_3  # Se falso, vai para fim
    # Comando: escreva string
.data
string_1: .asciiz "a OR b eh verdadeiro"
.text
...
Label_3:
    # Comando: se
    seq $t0, $t0, $zero # Negacao logica
    beq $t0, $zero, Label_5  # Se falso, vai para fim
    # Comando: escreva string
.data
string_2: .asciiz "NOT b eh verdadeiro"
.text
